...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   _______ ,M_DOTSLH,KC_ASTR ,TH_SLSH ,TH_BSLS ,TH_COLON,                           KC_DEL  ,KC_1    ,KC_2    ,KC_3    ,KC_DOT  ,_______ ,
    ...
    _______ ,XXXXXXX ,W_MDSWI ,KC_MPLY ,KC_VOLU ,KC_MUTE ,                           KC_MUTE ,KC_VOLU ,KC_MPLY ,W_MDSWI ,XXXXXXX ,_______ ,
    _______ ,XXXXXXX ,KC_MPRV ,KC_MNXT ,KC_VOLD ,PIPMODE ,                           PIPMODE ,KC_VOLD ,KC_MNXT ,KC_MPRV ,XXXXXXX ,_______ ,
                     _______ ,_______ ,                                                               _______ ,_______ ,
                                               _______ ,_______ ,         _______ , _______ ,
                                               _______ ,_______ ,         _______ , _______ ,
                                               _______ ,_______ ,         _______ , _______
   ...
   _______ ,_______ ,_______ ,_______ ,TO(_GAME),_______,                           _______ ,TO(_GAME),_______,_______ ,_______ ,_______ ,
   ...
   _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,                           _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,
    ...
    [_GAME] = LAYOUT_5x6(
   KC_ESC  , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,                            XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,_______ ,
   KC_T    , KC_TAB , KC_Q   , KC_W   , KC_E   , KC_R   ,                            XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,_______ ,
   KC_G    , KC_LCTL, KC_A   , KC_S   , KC_D   , KC_F   ,                            XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,_______ ,
   KC_B    , KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   ,                            XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,_______ ,
                     KC_LALT ,XXXXXXX ,                                                               _______ ,_______ ,
   ...
   _______ , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                            KC_N   , KC_M   ,KC_COMM , KC_DOT , KC_SLSH,_______ ,
    ...
    [_ADJUST] = LAYOUT_5x6(
   SETMAIN ,QK_BOOT ,_______ ,_______ ,_______ ,_______ ,                           _______ ,_______ ,_______ ,_______ ,QK_BOOT ,KC_PWR  ,
   _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,                           _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,
   _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,                           _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,
   _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,                           _______ ,_______ ,_______ ,_______ ,_______ ,_______ ,
                     _______ ,_______ ,                                                               _______ ,_______ ,
